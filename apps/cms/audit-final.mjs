...
async function audit() {
  console.log('📊 Auditing CMS content...\n');
  ...
  for (const collection of collections) {
    ...
    console.log(`${status} ${collection.padEnd(25)} EN: ${enCount.toString().padStart(3)}  AR: ${arCount.toString().padStart(3)}`);
  }
  ...
  for (const singleType of singleTypes) {
    ...
    console.log(`${status} ${singleType.padEnd(25)} EN: ${enStatus}    AR: ${arStatus}`);
  }
